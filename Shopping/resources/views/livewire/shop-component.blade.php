							...
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->cat_id}},'{{$product->name}}',{{$product->regular_price}})">Add To Cart</a>
									</div>
								</div>
							</li>
							@endforeach
								...
								<li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">₹200.00</span></div>
										</div>
									</div>
								</li>
